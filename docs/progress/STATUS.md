...
## 当前状态: 可发布 (Release Ready / Controlled Deployment)
...
```
发布门禁: ./scripts/agent_planner_acceptance.sh --full PASS
focused gate: 70 passed, 1 warning
full pytest: 1053 passed, 2 skipped, 21 warnings in 49.58s
live health: mode=orchestrate, fake_prompt_tools=false, supported_paths=21
scoped live audit: 12/12 proven/current_scope, missing_session_count=0
说明: 受控环境可发布；公网/生产前必须更换默认 Admin 密码。
```
