...
AI Gateway 中游服务 - 将各种上游 API 封装为完整支持 tool calls 的统一接口，支持无限上下文、智能缓存、协议转换。
...
| Tool Calls | `gateway_tool_runtime.py` | ✅ DONE | 25 pass | 完整支持，Claude 兼容 |
...
```
总计: 779 tests passed, 2 skipped
通过率: 100%
```

| 测试文件 | 数量 |
|----------|------|
| tests/test_gateway.py | 195 |
